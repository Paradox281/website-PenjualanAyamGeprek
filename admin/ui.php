...
<table border="1" cellpadding="10" cellspacing="0" style="width: 100%;color: white;">
    <thead>
        <tr>
            ...
            <th style="text-align: center; color: black;">Gambar</th>
            <th style="text-align: center; color: black;">Qty</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="width: 10%; text-align: center; color: black;"><?php echo $pecah ['kode_produk'];?></td>
            <td style="width: 15%; text-align: center; color: black;"><?php echo $pecah ['nama_produk'];?></td>
            <td style="width: 20%; text-align: center; color: black;"><?php echo $pecah ['deskripsi_produk'];?></td>
            <td style="width: 20%; text-align: center; color: black;"><img style="width: 50%; height: 100px; padding: 5px;" src="produk/<?php echo $pecah['product_img_name'];?>"></td>
            <td style=" color: black;"><?php echo $pecah ['qty'];?></td>
            <td style=" color: black;"><?php echo $pecah ['harga'];?></td>
            <td style="display: flex;">
            <div>    
            <a class="button" href="ubahproduk.php?kode=<?= $pecah['kode_produk'] ; ?>">Ubah</a>
            </div>
